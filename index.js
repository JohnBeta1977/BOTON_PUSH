...
// Puedes encontrarla en la misma sección de Firebase Cloud Messaging donde generaste la clave pública.
const VAPID_PRIVATE_KEY = 'BInO8Dg-awsarYdPs6eFZNO4sgOCNbHkJkuFHzLt25xPcDAjGLwrKwUwW5ci-5IqKNSvOoSmji5U3G9bMbobG3M';

// Configurar web-push
const webpush = require('web-push');
webpush.setVapidDetails(
    'mailto:viviraplicaciones@gmail.com', // Reemplaza con tu correo electrónico
    'BInO8Dg-awsarYdPs6eFZNO4sgOCNbHkJkuFHzLt25xPcDAjGLwrKwUwW5ci-5IqKNSvOoSmji5U3G9bMbobG3M', // Tu clave VAPID pública
...
exports.sendDailyPushNotification = functions.pubsub.schedule('0 10 * * *').onRun(async (context) => {
    // Esta función se ejecutará todos los días a las 10:00 AM (UTC)
    ...
    try {
        ...
        subscriptionsSnapshot.forEach(async doc => {
            ...
            try {
                ...
                console.error('Failed to send notification to a subscription:', error);
            }
        });
